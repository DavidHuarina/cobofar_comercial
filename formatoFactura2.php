...
?>
<style type="text/css">
	@font-face{font-family:'Lucida';font-style:normal;font-weight:normal;src:url(assets/lucida/type.ttf) format('truetype')}

	div {color:#000;font-family: 'Lucida' !important; }
	/*@media print {
      body {
