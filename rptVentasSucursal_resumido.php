...
<table style='margin-top:-90 !important' align='center' class='textotit' width='70%'><tr><td align='center'>Reporte Ventas x Sucursal Resumido
...
while($datosSuc=mysqli_fetch_array($respSucursal)){
  ...
  while($tiempoInicio2 <= $tiempoFin){
    ...
    //echo $codigoSuc.",".$dateInicio."..-.".$dateFin."<br>";
