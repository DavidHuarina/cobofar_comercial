...
if($filtro==1){
	...
	echo "<tr class='textomini'><th>Nro.</th><th>Nota de Entrega</th><th>Fecha Salida</th><th>Fecha Ingreso</th><th>Tiempo Transcurrido</th><th>Tipo de Ingreso</th><th>Observaciones</th><th>Desde</th></tr>";
	$index=0;
	while($dat=mysqli_fetch_array($resp))
	{
        ...
        //$hora_rest=$dat[9];
		if($rpt_linea==0)
		{	echo "<tr style='color:$color_fondo' class='$estiloMostrarFila'><td align='center'>$index</td><td align='center'>&nbsp;$nota_entrega</td><td align='center'>$fecha_salida_mostrar</td><td align='center'>$fecha_ingreso_mostrar</td><td align='center'>$hora_rest</td><td>$nombre_tipoingreso</td><td>&nbsp;$obs_ingreso</td><td align='center'>$detalle_ingreso</td></tr>";
		}
		if($rpt_linea!=0 and $bandera==1)
		{	echo "<tr style='color:$color_fondo' class='$estiloMostrarFila'><td align='center'>$nro_correlativo</td><td align='center'>&nbsp;$nota_entrega</td><td align='center'>$fecha_salida_mostrar</td><td align='center'>$fecha_ingreso_mostrar</td><td align='center'>$hora_rest</td><td>$nombre_tipoingreso</td><td>&nbsp;$obs_ingreso</td><td align='center'>$detalle_ingreso</td></tr>";
		}
	}
