...
{	var fecha_ini, fecha_fin, rpt_formato;
	...
	window.open('rptLogPrecios.php?codTipoTerritorio='+codTipoTerritorio+'&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+''+'&codSubGrupo='+codSubGrupo+''+'&rpt_formato='+rpt_formato+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,height=800');			
	return(true);
}
...
echo"<form method='post' action='rptOpLogPrecios.php'>";
	...
	echo"\n<table class='' align='center' cellSpacing='0' width='80%'>\n";
