...
echo "<script language='JavaScript'>
		...
		{	var rpt_territorio,rpt_almacen, tipo_ingreso,fecha_ini, fecha_fin;
			...
			window.open('rpt_inv_ingresos_periodo.php?rpt_territorio='+rpt_territorio+'&rpt_almacen='+rpt_almacen+'&tipo_ingreso='+tipo_ingreso+'&periodo='+periodo+'&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');
			return(true);
		}
...
echo"<form method='post' action=''>";
	...
	echo "<tr><th align='left'>Territorio</th><td><select name='rpt_territorio' class='selectpicker form-control' data-style='btn btn-primary' onChange='envia_select(this.form)'>";
	...
	echo "<td><select name='tipo_ingreso' class='selectpicker form-control' data-style='btn btn-primary'>";
	...
	echo "</select></td>";
    echo "<tr><th align='left'>Periodo</th>";
