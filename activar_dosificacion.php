<?php
	...
	$codRegistro=$_GET['codigo_registro'];
		...
		$sqlUpd="select tipo_dosificacion from dosificaciones where cod_dosificacion=$codRegistro";
		//echo $sqlUpd;
		$respUpd=mysqli_query($enlaceCon,$sqlUpd);
		$tipoDosificacion=mysqli_result($respUpd,0,0);
		
		$sqlUpd1="update dosificaciones set cod_estado='3' where cod_sucursal in ($codSucursal) and cod_estado in (1,2) and tipo_dosificacion='$tipoDosificacion'";
