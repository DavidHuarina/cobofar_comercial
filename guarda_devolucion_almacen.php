...
$sql_inserta=mysqli_query($enlaceCon,"insert into ingreso_almacenes values($codigo,$global_almacen,1001,'$fecha_real','$hora_sistema','Por devolucion de ciclo. Visitador: $nombreVisitador',1,0,'0','$nro_correlativo',0)");
...
{	$cod_material=$tags2[$i];
	...
	$nroLote=mysqli_result($respLote,0,0);
	$fechaVenci=mysqli_result($respLote,0,1);
	...
	$resp_inserta2=mysqli_query($enlaceCon,$sql_inserta2);
