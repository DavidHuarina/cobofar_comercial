...
$sql_detalle_salida="select cod_ingreso_almacen, cod_material, sum(cantidad_unitaria), costo_almacen
...
{	$cod_material=$dat_detalle_salida[1];
	...
	echo "<input type='text' value='$costo_almacen' name='precio$indice_detalle'>";
