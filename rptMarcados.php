...
while($datPersonal=mysqli_fetch_array($respPersonal)){
	...
	echo "<tr class='bg-principal'><td>Fecha</td><td>Marcado1</td><td>Marcado2</td><td>Marcado3</td><td>Marcado4</td><td>Marcado5</td><td>Marcado6</td><td>Horas trabajadas</td></tr>";
