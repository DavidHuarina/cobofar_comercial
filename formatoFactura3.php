...
?>
<style type="text/css">
	@font-face{font-family:agency fb;font-style:normal;font-weight:800;color:#C5C2C3;src:local('Agency FB'),local('AgencyFB-Regular'),url(http://allfont.net/cache/fonts/agency-fb_0b9596562659a0772f5e24c22cae921b.woff) format('woff'),url(http://allfont.net/cache/fonts/agency-fb_0b9596562659a0772f5e24c22cae921b.ttf) format('truetype')}

	div {color:#000;font-family: 'agency fb' !important; }
	/*@media print {
      body {
...
?><div style="width:330;margin:0;padding-left:30px !important;padding-right:30px !important;height:<?=$tamanoLargo?>; font-family:Arial;">
<?php	
