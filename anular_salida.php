...
if(isset($_GET["obs"])){
  ...
  $sql="update salida_almacenes set salida_anulada=1,estado_salida=3,observaciones_transito='$obsAnulacion' where cod_salida_almacenes='$codigo_registro' and salida_anulada=0";
}
...
{	$codigo_ingreso=$dat_detalle[0];
	...
	$sql_ingreso_cantidad="select cantidad_restante from ingreso_detalle_almacenes
							where cod_ingreso_almacen='$codigo_ingreso' and cod_material='$material' and lote='$nro_lote'";
