...
foreach ($listProd->lista as $prod) {
  ...
  if($cod_existe>0){
        ...
        $sql="UPDATE material_apoyo SET descripcion_material='$nombre',estado='$estado',cod_linea_proveedor='$cod_linea',cod_forma_far='$cod_forma_far',cod_empaque='$cod_empaque',cantidad_presentacion='$cantidad_presentacion',principio_activo='$principio_activo',cod_tipoventa='$cod_tipoventa',divi='$div' 
        where codigo_material='$codigo'"; //,producto_controlado='$sico'
