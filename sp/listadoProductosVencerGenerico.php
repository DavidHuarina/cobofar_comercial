...
?>
<center><h3><b>PRODUCTOS A VENCER</b></h3></center>
<center>
<br>
<div class="col-sm-10 div-center">
  <form method="POST" action="listadoProductosVencer2.php">
    <table class="table table-condensed table-bordered ">
    <tr class="">
        <td>PROVEEDOR:</td>
        <td><select name='proveedor' class='selectpicker form-control' data-live-search="true" data-style='btn btn-primary'><?php 
