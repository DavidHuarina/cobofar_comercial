...
echo "<script language='Javascript'>
		function enviar_nav()
		{	location.href='registrar_formafar.php';
		}
		function eliminar_nav(f)
		{
			...
			else
			{
				...
				{
					location.href='deleteFormasfar.php?datos='+datos+'';
				}
				else
				{
					return(false);
		...
		function editar_nav(f)
		{
			...
			else
			{
				...
				{
					location.href='editar_formafar.php?codigo_registro='+j_cod_registro+'';
				}
			}
		}
		</script>";
	...
	$sql="select e.cod_forma_far, e.nombre_forma_far from formas_farmaceuticas e where e.estado=1 order by 2";
	$resp=mysqli_query($enlaceCon,$sql);
	echo "<h1>Formas Farmaceuticas</h1>";
    echo "<div class=''>
