...
$sql="INSERT INTO medicos(nombres,apellidos,direccion,matricula,cod_institucion,cod_especialidad,cod_especialidad2,estado) VALUES('$nom_doctor','$ape_doctor','$dir_doctor','$mat_doctor','$ins_doctor','$esp_doctor','$esp_doctor2',1)";
$resp=mysqli_query($enlaceCon,$sql);
