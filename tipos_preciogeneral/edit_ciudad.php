...
$sql="select d.cod_ciudad,(SELECT cod_ciudad from tipos_preciogeneral_ciudad where cod_tipoprecio=$codigo_registro and cod_ciudad=d.cod_ciudad) from ciudades d where d.cod_estadoreferencial=1 order by 1";
