...
fecha_limite_emision, cod_estado,tipo_dosificacion,nro_inicio) values ('$fechaActual','$codSucursal','$nroAutorizacion','$llaveDosificacion','$fechaLimiteEmision','2','$tipo_dosificacion','$nro_inicio')";
//echo $sql_inserta;
